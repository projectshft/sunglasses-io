...
/**
 * Test the products and brands server routes. These routes should allow a client to retrieve data on all products on brands or a single product or brand by id.
 */
const testSunglasses = () => {
...
export type TestSunglasses = typeof testSunglasses;

module.exports = testSunglasses;
